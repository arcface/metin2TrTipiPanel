...
ALTER TABLE `account` ADD `arc_rank` INT(11) NOT NULL AFTER `cash`, ADD `arc_conf` INT(11) NOT NULL AFTER `arc_rank`, ADD `arc_ref_code` VARCHAR(150) NOT NULL AFTER `arc_conf`;
